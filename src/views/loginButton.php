<div class="dropdown d-flex position-absolute position-xs- top-0 end-0  d-x1-block d-xl-flex">
        <button type="button" id="menuboton" class="btn btn-light dropdown-toggle" data-bs-toggle="dropdown" aria-label="Open Menu">
        ...
        <ul class="dropdown-menu">
            <?php
                ...
                if (!$logged) {
                    ...
                    echo '<li><a class="dropdown-item" href="index.php?r=llistaReservaUsuari">Reserves</a></li>';
                    ...
                    if($_SESSION["user"]["Rol"] == "Gestor") {                        // Mostrar botones si eres gestor
                        ...
                        echo '<li><a class="dropdown-item" href="index.php?r=gestioReserves">Gestio reserves</a></li>';
                    }
