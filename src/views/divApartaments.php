            ...
            <div class="modal-dialog modal-dialog-scrollable custom-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <p type="hidden">prueba: <?= $value['ID_Apartament']; ?></p>
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" data-bs-dismiss="modal" onclick="asociarApartamentId('<?= $value['ID_Apartament']; ?>')">Continuar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="index.php" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cerrar</button>
                        <button type="submit" class="btn btn-primary" onclick="actualizarCampoOculto()">Reservar</button>
                    </div>
                    <input type="hidden" name="Descripcio" value="<?= $value["Descripcio"]; ?>">
                    <input type="hidden" name="ID_Apartament" id="apartamentIdField" value="">                
                </form>
            </div>
        </div>
    </div>
